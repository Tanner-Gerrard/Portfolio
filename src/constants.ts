...
export const PROJECTS: Project[] = [
  {
    ...
    image: img04hero,
    video: '/images/projects/04-corium-glove/corium-glove.mp4',
    youtubeUrl: 'https://youtu.be/FKb5Zg6Q7TI',
    detailImages: [
      '/images/projects/04-corium-glove/process42.avif',
      '/images/projects/04-corium-glove/process43.avif',
      '/images/projects/04-corium-glove/detail-1.avif'
    ],
    specs: {
    ...
    technicalOverview: 'Constructed from 0.8mm technical leather with high-tenacity UHMWPE stitching. Eliminates bulky rubber overlays to deliver maximum sensitivity, breathability, and durability.',
    keyFeatures: [
      "0.8mm Technical Leather — High-density collagen fibers deliver 10x the tensile strength of standard leather.",
      "Recessed Closure — Sits below the surface to prevent snagging during deep hand jams.",
      "UHMWPE Stitching — Abrasion-resistant seams engineered for rough rock.",
      "Tactile Sensitivity — Pure leather construction eliminates rubber overlays for direct feedback"
    ],
  ...
  },
  {
    ...
    detailImages: [
      ...
      '/images/projects/01-alptour-pack/process-1.avif'
    ],
    specs: {
      material: 'Ultra 200X',
      movement: 'Sustained',
